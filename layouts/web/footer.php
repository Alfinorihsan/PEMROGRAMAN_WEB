<footer>
    <div class="footer-wrapper section-bg2 pl-100" data-background="../../assets/web/img/gallery/footer-bg.png">
        <!-- Footer Start-->
                        ...
                        <div class="single-footer-caption text-center mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo mb-35">
                                    <a href="index.html"><img src="../../assets/web/img/logo/logo.png" style="height: 100px;" alt=""></a>
                                </div>
...
<!-- Progress -->
<script src="../../assets/web/js/jquery.barfiller.js"></script>

<!-- counter , waypoint,Hover Direction -->
<script src="../../assets/web/js/jquery.counterup.min.js"></script>
<script src="../../assets/web/js/waypoints.min.js"></script>
<script src="../../assets/web/js/jquery.countdown.min.js"></script>
<script src="../../assets/web/js/hover-direction-snake.min.js"></script>
